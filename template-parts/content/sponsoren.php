<section class="sponsoren-wrapper">
	...
	if ( have_rows( 'sponsoren' ) ) :
		while ( have_rows( 'sponsoren' ) ) :
			the_row();
			echo '<div class="sponsor"><div class="container"><div class="row">';
			...
			if ( $sponsors ) :
				foreach ( $sponsors as $sponsor ) :
					...
					echo '<div class="col-12 col-lg-3 sponsor__logo"><a href="' . esc_url( $sponsor['link'] ) . '" target="_blank">' . wp_get_attachment_image( $sponsor['image'], 'sponsoren-logo-thumb' ) . '</a></div>';
				endforeach;
			endif;
			echo '</div></div></div>';
		endwhile;
